            ...
            <div className='dark:bg-[#141625] scrollbar-hide duration-300 min-h-screen bg-[#f8f8fb] py-[34px] px-2 md:px-8 lg:px-12 lg:py-[72px]  '>
                ...
                <div
                    ...
                    <div className=' min-w-full max-h-[64px] flex items-center justify-between'>
                        <div>
                            <h1 className=' lg:text-4xl md:text-2xl  text-xl  dark:text-white tracking-wide font-bold'>Invoices</h1>
                        ...
                        <div className=' flex  max-h-full  items-center '>
                            <div className=' flex items-center'>
                                <p className=' hidden md:block dark:text-white font-bold'>
                                    Filter by status
                                </p>
                                <p className='  md:hidden dark:text-white font-bold'>
                                    Filter
                                </p>
                                <div onClick={() => { setIsDropdown((state) => !state) }} className=' cursor-pointer ml-3 '>
                                    {
                                        <img src={arrowDown} animate={isDropdown ? { transition, rotate: -180 } : { transition, rotate: 0 }} />
                                    }
                                </div>
                            </div>
                            {isDropdown &&
                                <div as='select' variants={varients} animate={
